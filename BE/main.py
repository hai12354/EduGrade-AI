...
from routers import ai_router, auth_router, users_router, classes_router, exams_router, settings_router
    ...
    if exc.status_code == 404:
        ...
        return JSONResponse(
            ...
            content={
                ...
                "available_prefixes": ["/api/ai", "/api/auth", "/api/users", "/api/classes", "/api/exams", "/api/settings"],
